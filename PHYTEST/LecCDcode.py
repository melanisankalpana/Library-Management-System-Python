...
class CdFunction:
    ...
    def __initial_data(self):
        a_book1 = Book(isbn_no="ISBN0001", title="Title1", book_format="Format1", subject="Science", rental_price=12.50,
                       copies=1)
        a_book2 = Book(isbn_no="ISBN0002", title="Title2", book_format="Format2", subject="Science", rental_price=22.50,
                       copies=0)
        a_book3 = Book(isbn_no="ISBN0003", title="Title3", book_format="Format3", subject="Science", rental_price=32.50,
                       copies=3)
    ...
    def add(self):
        ...
        a_book = Book(isbn_no=__isnb, title=__title, book_format=__book_format, subject=__subject,
