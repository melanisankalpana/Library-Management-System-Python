...
class BookFunction:
    ...
    def __initial_data(self):
        a_book1 = Book(isbn_no="ISBN0001", title="The Solar System", book_format="Hardcover", subject="Science", rental_price=12.50, copies=1)
        a_book2 = Book(isbn_no="ISBN0002", title="Types of Animal Species", book_format="Paperback", subject="Science", rental_price=22.50, copies=0)
        a_book3 = Book(isbn_no="ISBN0003", title="Second World War", book_format="Hardcover", subject="Science", rental_price=32.50, copies=3)
