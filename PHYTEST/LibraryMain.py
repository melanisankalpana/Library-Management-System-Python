from booksCodes import BookFunction
from lecturecdfunction import LectureCDFunction
from magazineCodes import MagFunction
from dvdcodes import DvdFunction
from LecCDcode import CdFunction

book_func = BookFunction()
lecture_cd_func = LectureCDFunction()
eternal_dvd_func = DvdFunction()
magazine_func = BookFunction()

# codes for submenu
def submenu(function_name, selected_resource):
    selected_operation = 1
    while selected_operation > 0:
        print("Select a number from here ")
        print("+++++++++++++++++++++++++")
...
def mainmenu():
    ...
    print("1 - Books")
    print("2 - Magazine")
    print("3 - Exeternal DVD")
    print("4 - Lecture CD")
    print("0 - Quit")


print("OPEN UNIVERSITY SRI LANKA")
print("==========================")
selected_resource = 1
while selected_resource > 0:
    ...
    if selected_resource == 0:
        ...
        submenu(function_name, "magazines")
        break
    elif selected_resource == 3:
        function_name = eternal_dvd_func
        submenu(DvdFunction, "DVD")
        break
    elif selected_resource == 4:
        function_name = lecture_cd_func
        submenu(function_name, "LectureCD")
        break
